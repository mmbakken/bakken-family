  ...
  return (
    <div className="flex h-dvh w-screen flex-col items-center gap-8 px-6 py-4">
      ...
      <main className="flex flex-col items-center gap-8">
        <p className="w-full">
          Since time immemorial, the humble tree nut has been a favorite food of
          all of God's critters: the squirrel with his stash of walnuts for the
          long winter ahead; the nuthatch, with his powerful beak, cracks open
          the fleshy sustenance of the... uh, probably also a walnut; The groom
          and his beloved candied pecans of long, long ago...
        </p>
        ...
        <hr className="border-primary my-4 w-full border" />

        <p className="w-full">
          Due to her her severe tree nut allergy and her very important role in
        ...
        <p className="w-full">
          We kindly ask that you let us feed you and leave all your nutty treats
          at home.
        </p>
        ...
        <p className="w-full">
          ...
          list first, and reach out to Hilary with any concerns you might have.
        </p>

        <p className="w-full">
          And even though there is a wood-burning fireplace at the lodge, please
          do not roast your chestnuts over the open fire.
        </p>
        ...
        <p className="flex w-full flex-col gap-2">
          ...
          <ul className="flex list-disc flex-col gap-2 px-4 text-sm">
            ...
            <li>
              Garbanzo beans, Chickpeas (they're beans, but people get confused
